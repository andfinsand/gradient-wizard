    ...
    return (
        <div className="flex justify-between w-full text-white mb-5">
            ...
            <div className="relative mx-3">
                ...
                {prevMessage && (
                    <div className={`flex justify-center items-center absolute bg-glassLight text-black text-xs italic rounded-md w-120 h-8 top-0 -translate-y-16 -translate-x-5 xs:-translate-x-10 ${prevFadeIn ? "fade-in" : ""} ${prevFadeOut ? "fade-out" : ""}`}
                        onAnimationEnd={() => {
